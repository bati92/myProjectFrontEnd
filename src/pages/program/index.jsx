...
export async function getStaticProps() {
    try {
        const result = await axios.get("http://127.0.0.1:8000/api/program");
        console.log(result.data.programs.data);
        console.log("http://127.0.0.1:8000/api/program");
        return {
            props: {
                className: "home-sticky-pin sidebar-header position-relative",
                myPrograms: result.data.programs.data,
            },
        };
    } catch {
        console.log("error");
